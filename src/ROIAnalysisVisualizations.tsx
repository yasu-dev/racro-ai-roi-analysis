            ...
            <div className="bg-gradient-to-br from-indigo-600 to-blue-700 p-1 rounded-2xl shadow-lg">
              <div className="bg-white p-6 rounded-xl h-full flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-right text-indigo-600 font-bold text-sm italic">→ 確実な効率化で、次への土台を築く</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-sky-600 to-teal-600 p-1 rounded-2xl shadow-lg">
              <div className="bg-white p-6 rounded-xl h-full flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-right text-sky-600 font-bold text-sm italic">→ 先行投資で市場を拓き、安定収益へ</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-violet-600 to-purple-700 p-1 rounded-2xl shadow-lg">
              <div className="bg-white p-6 rounded-xl h-full flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-right text-violet-600 font-bold text-sm italic">→ 圧倒的な成長で未来をリード</p>
                </div>
              </div>
            </div>
          </div>
